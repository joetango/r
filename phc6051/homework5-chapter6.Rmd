...
We have a deviance of 51.795 on 6 degrees of freedom, which further suggests dependence. (p 110)
...
As previously pointed out, we see a correspondence between freckle and head. We also see this with indeterminate and trunk. 
...
A G-test on the data set without the head location fails to reject the null of independence.
