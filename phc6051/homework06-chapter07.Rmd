...
The year effect does not appear significant in this model. The relationship of year on mild and severe is similar.  
...
p1 <- predict(bmod1, type = "response")
p2 <- predict(bmod2, type = "response")

bmodPreds <- cbind(p1, p2)
