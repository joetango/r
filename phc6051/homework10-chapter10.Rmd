...
We have a p-value of 0.064, which is slightly larger than what we found with the Kenward-Roger approximation, though they are relatively close to one another given the size of the dataset. 
