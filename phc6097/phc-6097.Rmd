...
cv.err <- cv.glm(Default, glm.mod2, K = 10) ## need to use K = 10 as my computer cannot run the LOOCV with a 10,000 obs dataset (I tried for several minutes)

round(cv.err$delta, 3)

```

3. cross-validation etc.
